...
type ValidationRailProps = {
  // Assignment-template-level settings
  ...
  onAssignmentTemplateRubricChange: (rubricId: number | null) => void;
...
function ValidationRail({
  ...
  onAssignmentTemplateRubricChange,
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center gap-1.5">
              ...
              <HelpTip text="Optional tag to organize assignment templates." />
            </div>
        ...
        <section className="p-3 bg-muted/30 rounded-lg border border-border">
          <div className="flex items-center gap-2 mb-2">
            <div className="flex items-center gap-1.5">
              ...
              <HelpTip text="Shows the currently selected question's type, relative weight in this assignment template, and whether it can be graded automatically." />
            </div>
          </div>
      ...
      >
        ...
        {!isRubricEnabled ? (
          ...
          <div className="space-y-2">
            <div className="space-y-1.5">
              <Label className="text-[10px] font-bold text-muted-foreground uppercase tracking-tight">
                Assignment Template Default
              </Label>
              <div className="grid grid-cols-[1fr_auto_auto] gap-1.5">
                <Select
                  value={
                    assignmentTemplateRubricId != null
                      ? String(assignmentTemplateRubricId)
                      : '__NONE__'
                  }
                  onValueChange={(value) =>
                    onAssignmentTemplateRubricChange(
                ...
                >
                  <SelectTrigger className="h-8 text-xs">
                    <SelectValue placeholder="No assignment template rubric" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="__NONE__">No assignment template rubric</SelectItem>
                    {rubrics.map((rubric) => (
                      <SelectItem
                        key={rubric.id}
                ...
                <Button
                  ...
                  size="icon"
                  className="h-8 w-8"
                  disabled={assignmentTemplateRubricId == null}
                  onClick={() => onOpenInlineRubricEditor(assignmentTemplateRubricId)}
                >
                ...
                <Button
                  ...
                  className="h-8 w-8"
                  disabled={assignmentTemplateRubricId == null}
                  onClick={() => onOpenRubricPreview(assignmentTemplateRubricId)}
                >
              ...
              <p className="text-[10px] text-muted-foreground">
                {assignmentTemplateRubricId != null
                  ? `Default rubric: ${
                      rubricById.get(assignmentTemplateRubricId)?.title ?? 'Unavailable'
                    }`
                  : 'No assignment-template-level default rubric'}
              </p>
              {assignmentTemplateRubricId != null && (
                <p className="text-[10px] text-amber-700 dark:text-amber-400">
                  Assignment-template-level rubric is active. Question and group rubrics must remain clear.
                </p>
              )}
            </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-[1fr_auto_auto] gap-1.5">
                  <Select
                    ...
                    disabled={assignmentTemplateRubricId != null || !activeQuestion}
                  >
                    <SelectTrigger className="h-8 text-xs">
                  ...
                  <Button
                    ...
                    size="icon"
                    className="h-8 w-8"
                    disabled={activeQuestionRubricId == null || assignmentTemplateRubricId != null}
                    onClick={() =>
                      onOpenInlineRubricEditor(
                        activeQuestionRubricId,
                      )
        ...
        <div className="space-y-2">
          ...
          {questionGroups.length > 0 && selectedAssignGroup && (
            <div className="rounded border border-border p-2 space-y-2">
              ...
              {isRubricEnabled && (
                <div className="grid grid-cols-[1fr_auto_auto] gap-1.5">
                  ...
                  <Button
                    ...
                    size="icon"
                    className="h-8 w-8"
                    disabled={selectedAssignGroup.rubricId == null || assignmentTemplateRubricId != null}
                    onClick={() =>
              ...
              {assignmentTemplateRubricId != null && (
                <p className="text-[10px] text-amber-700 dark:text-amber-400">
                  Clear the assignment template rubric before assigning a group rubric.
                </p>
              )}
          ...
          {issues.length === 0 && questions.length > 0 && (
            <div className="p-4 bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-800/30 rounded-lg text-center">
              ...
              <p className="text-xs text-green-600/70 dark:text-green-400/70 mt-1">
                Assignment template is ready to save.
              </p>
            </div>
          )}
        </div>
