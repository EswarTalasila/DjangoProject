...
type QuestionStudioProps = {
  ...
  rubricSource: 'Question' | 'Group' | 'AssignmentTemplate' | 'N/A';
    ...
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <p className="text-base text-muted-foreground max-w-sm mb-8">
          Add your first question to begin building this assignment template.
        </p>
          ...
          >
            ...
            {highlightedSection === 'prompt' && (
              <p className="text-xs font-medium text-amber-700 dark:text-amber-400">
                This question needs prompt text before the assignment template can be saved.
              </p>
            )}
            <textarea
              ref={promptRef}
