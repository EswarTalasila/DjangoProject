...
import type { QuestionData, McqChoice } from '@/lib/assignment-template-api';
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-muted-foreground">
        Assignment template totals are built from question values, and multiple choice question values are derived from these choice values automatically.
      </p>
    </div>
  );
}
