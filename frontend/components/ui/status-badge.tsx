...
const STATUS_MAP: Record<string, { variant: BadgeVariant; label: string }> = {
  ...
  NOT_STARTED: { variant: 'archived', label: 'Not Started' },
  IN_PROGRESS: { variant: 'draft', label: 'In Progress' },
  SUBMITTED: { variant: 'snapshot', label: 'Submitted' },
  GRADED: { variant: 'active', label: 'Graded' },
