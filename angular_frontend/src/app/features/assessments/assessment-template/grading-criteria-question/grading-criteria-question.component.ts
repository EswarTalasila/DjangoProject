...
@Component({
  selector: 'app-grading-criteria-question',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './grading-criteria-question.component.html',
  styleUrl: './grading-criteria-question.component.scss'
})
export class GradingCriteriaQuestionComponent {
