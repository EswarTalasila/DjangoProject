...
@pytest.mark.django_db
@pytest.mark.integration
def test_REG_UC_02_E5_create_registration_codes_researcher_requires_sudo_for_researcher_codes():
...
@pytest.mark.django_db
@pytest.mark.integration
def test_REG_UC_02_RESEARCHER_WITH_PERMISSION_create_registration_codes_researcher_with_permission_can_generate_researcher_codes():
