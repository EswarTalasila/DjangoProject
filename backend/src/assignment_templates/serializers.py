"""AssignmentTemplate serializers."""
...
class QuestionSerializer(serializers.Serializer):
    """Serializer for a single assignment_template question with type, prompt, scoring, and optional rubric."""
...
class AssignmentTemplateSerializer(serializers.Serializer):
    """Top-level serializer for creating/updating an assignment_template with questions and groups."""
    ...
    def validate(self, attrs):
        ...
        if self.initial_data and isinstance(self.initial_data, dict):
            legacy_fields = {"rubricAssignmentTemplateIds"}
